...
func (t *Simple) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	case "userQueryCouchdb":
		return userQueryCouchDB(stub, args)
	default:
...
func userQueryCouchDB(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	if len(args) < 1 {
		return shim.Error("Incorrect number of arguments. Expecting 1")
	}
